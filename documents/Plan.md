...
**Сценарий 4. Тестирование нижней границы значения поля "Месяц"**
...
## План сдачи работ:
1. План тестирования - в течение 3 дней после начала работы над проектом.
2. Рабочие автотесты - через 2-3 недели после утверждения лана.
2. Отчеты - через 3 дня после проведения автотестов.